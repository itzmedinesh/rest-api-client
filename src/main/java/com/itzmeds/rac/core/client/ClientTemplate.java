...
public interface ClientTemplate<T> {
	...
	/**
	 * Performs POST call on the WEB API. <E> is the entity type of the WEB API POST
	 * body, such as 'json', 'form', 'xml'
	 * 
	 * @param queryParams
	 *            - Key Value Pairs that appears as query parameters in the WEB
	 *            service access URL. <M> is of type 'String' for single valued
	 *            query parameter and type 'List<String>' for multi-valued query
	 *            parameters.
	 * @param pathParams
	...
	/**
	 * Performs PUT call on the WEB API. <E> is the entity type of the WEB API POST
	 * body, such as 'json', 'form', 'xml'
	 * 
	 * @param queryParams
	 *            - Key Value Pairs that appears as query parameters in the WEB
	...
	/**
	 * Performs POST call on the basic authentication enabled WEB API. <E> is the
	 * entity type of the WEB API POST body, such as 'json', 'form', 'xml'
	 * 
	 * @param queryParams
	 *            - Key Value Pairs that appears as query parameters in the WEB
	 *            service access URL. <M> is of type 'String' for single valued
